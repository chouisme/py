...
watch_val = str(input("看大盤請輸入：1 看個股請輸入：2"))

if watch_val == "1":
  response =requests.post("https://ww2.money-link.com.tw/TWStock/TWStockMarket.aspx?optionType=2#SubMain",headers=head)
